...
namespace arm_controllers{
	...
	class VisualServoingController: public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		public:
		...
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
  		{	
			...
			command_sub_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &VisualServoingController::commandCB, this);
...
PLUGINLIB_EXPORT_CLASS(arm_controllers::VisualServoingController, controller_interface::ControllerBase)
